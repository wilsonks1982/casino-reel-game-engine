# Casino Reel Game Engine

## Overview

A Class III-style casino slot backend consisting of:

3 weighted reels
43 primary payline combinations
5 bonus games
Progressive jackpot
Meter accounting
Persistent game history
Test/gaffing support

A backend system built on Node.js with MongoDB and RabbitMQ. It manages player accounts, game mechanics, progressive jackpots, and real-time communication with gaming machines in a casino environment.
